...
def test_frozen_ring_count_resets_on_event() -> None:
    ...
    anyio.from_thread.run_sync  # just to confirm anyio is available

    # Call on_event synchronously via the sync path
    # on_event resets stall state when _stall_warned is True
    import asyncio
