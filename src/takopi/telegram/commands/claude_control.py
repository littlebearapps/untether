...
_DISCUSS_DENY_MESSAGE = (
    ...
    "CONTEXT: The user is on Takopi (Telegram bridge). They can ONLY see your assistant text "
...
_DENY_MESSAGE = (
    "User denied via Telegram (Takopi bridge). They cannot see your tool calls "
